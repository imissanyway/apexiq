...
const VERSION = "4.9.9.131-worker-auto-key-delivery-recovery";
    ...
    try {
      ...
      if (url.pathname === "/api/health") {
        return json({
          ...
          rollbackSafe: true,
          stableBase: "v4.6.8",
          endpoints: ["/api/player","/api/ranked-fast","/api/ranked","/api/meta","/api/beta/verify","/api/beta/session","/api/beta/admin/login","/api/beta/founder-status","/api/beta/request-access","/api/beta/request-status","/api/beta/request-recover","/api/beta/admin/users","/api/beta/admin/set-founder","/api/beta/admin/requests","/api/beta/admin/request-approve","/api/beta/admin/request-delete","/api/beta/admin/logout","/api/rendered-profile","/api/badge-scan","/api/rendered-ranked","/api/doctor","/api/als-test","/api/switch-ranked","/api/health"]
        }, origin);
      }
...
async function betaRequestAccess(kv, body, request) {
  ...
  const record = {
    id,
    apexUsername,
    apexUsernameNorm: normUsername(apexUsername),
...
async function betaAdminRequestUpdate(kv, body, admin) {
  ...
  if (next === "denied") rec.deniedAt = rec.updatedAt;
