    ...
    try {
      ...
      if (url.pathname === "/api/health") {
        return json({
          ...
          rollbackSafe: true,
          stableBase: "v4.6.8",
          endpoints: ["/api/player","/api/ranked-fast","/api/ranked","/api/meta","/api/beta/verify","/api/beta/session","/api/beta/admin/login","/api/beta/admin/users","/api/beta/admin/logout","/api/rendered-profile","/api/badge-scan","/api/rendered-ranked","/api/doctor","/api/als-test","/api/switch-ranked","/api/health"]
        }, origin);
      }
